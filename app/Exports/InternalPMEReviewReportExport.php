...
class InternalPMEReviewReportExport implements FromView, WithEvents
// , ShouldAutoSize
{
    protected $project;
    protected $project_datas;
    protected $selected_months;
    protected $is_target_report;
    protected $for_single_project;

    public function __construct(InternalProject $project, $project_datas, $selected_months)
    {
        $this->project = $project;
        $this->project_datas = $project_datas;
    ...
    public function view(): View
    {
        ...
        return view('admin.excel.internal-pme-review-report', [
            'project' => $this->project,
            'project_datas' => $this->project_datas,
