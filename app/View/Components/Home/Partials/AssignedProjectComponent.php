...
class AssignedProjectComponent extends Component
{
    public $fiscal_year;
    /**
    ...
    public function render()
    {
        ...
        $projectactivity = ProjectActivity::where("fiscal_year", $this->fiscal_year)->where(function ($query) {
        ...
        return view('components.home.partials.assigned-project-component', [
