...
class DateConverter
{
    ...
    public function toFormattedNepaliDateArray()
    {
        ...
        return [
            ...
            'month_in_english' => $this->formattedEnglishMonth($this->nepaliMonth),
        ];
    }
    ...
    public function formattedEnglishMonth($month)
    {
        return $this->monthsInEnglish[$month];
    }
