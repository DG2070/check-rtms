...
@can('Set Target')
    <li class="nav-item">
        <a class="tdf_tab btn btn-primary btn-tdf-primary_tabs tdf-border-small" id="activities_milestones-tab" data-toggle="tab"
...
@can('Target Report')
    <li class="nav-item">
        <a class="tdf_tab btn btn-primary btn-tdf-primary_tabs tdf-border-small" id="target_report-tab" data-toggle="tab"
...
@can('Progress Input')
    <li class="nav-item">
        <a class="tdf_tab btn btn-primary btn-tdf-primary_tabs tdf-border-small" id="progress_input-tab" data-toggle="tab"
...
@can('Progress Report')
    <li class="nav-item">
        <a class="tdf_tab btn btn-primary btn-tdf-primary_tabs tdf-border-small" id="progress_report-tab" data-toggle="tab"
...
@can('PME Review')
    <li class="nav-item">
        <a class="tdf_tab btn btn-primary btn-tdf-primary_tabs tdf-border-small" id="pme_report_input-tab" data-toggle="tab"
...
@can('PME Final Report')
    <li class="nav-item">
        <a class="tdf_tab btn btn-primary btn-tdf-primary_tabs tdf-border-small" id="pme_final_report-tab" data-toggle="tab"
...
@can('Physical Progress')
    <li class="nav-item">
        <a class="tdf_tab btn btn-primary btn-tdf-primary_tabs tdf-border-small" id="physical_progress-tab" data-toggle="tab"
