 <div>
     <table border="1">
         <thead style="background: #2767a0;color:white;">
             <tr>
                 <th colspan="{{ 4 + $quaterfilter->allQuaterCount() + 4 }}"
                 ...
                 @foreach ($project_datas as $item)
                     <tr>
                         <td rowspan="{{ $is_target_report ? 1 : 2 }}"
                             style="text-align: center; vertical-align: center;">{{ $loop->index + 1 }}
                         </td>
                         <td rowspan="{{ $is_target_report ? 1 : 2 }}" style="text-align: left;">
