<div>
    <table border="1">
        <thead style="background: #2767a0;color:white;">
            <tr>
                <th colspan="{{ 7 + 4 + $quaterfilter->allQuaterCount() + 7 }}"
            ...
            <tr>
                ...
                <th rowspan="3"
                    style="text-align: center; vertical-align: center; background-color: #2767a0;color:white;">Progress
                </th>
                <th colspan="2"
                    style="text-align: center; vertical-align: center; background-color: #2767a0;color:white;">PME
                    Review</th>
                <th colspan="2"
                    style="text-align: center; vertical-align: center;  background-color: #2767a0;color:white;">
                    Responsibility</th>
                        ...
                        <tr>
                            @if ($key == 0 && $key2 == 0)
                                ...
                                <td rowspan="{{ $count * 2 }}"
                                    ...
                                    {{ $project->Name }}</td>
                                <td rowspan="{{ $count * 2 }}" style="text-align: center; vertical-align: center;">
                            ...
                            @if ($key2 == 0)
                                <td rowspan="{{ count($pro_act->milestone) * 2 }}"
                            ...
                            @if ($mile->timeline)
                                @foreach ($mile->timeline->timeline ?? [] as $timeline_month => $time)
                                    @if (in_array($timeline_month, $quaterfilter->showMonths()))
                                        ...
                                        @else
                                            <td
                                                @if ($time) style="background: #28a745;border-radius: 20px;" @endif>
                            ...
                            <td rowspan="2" style="text-align: left; vertical-align: center;word-wrap:break-word;">
                                <div>
                                    {{ isset($project->projectReview->progress[$mile->id]) ? $project->projectReview->progress[$mile->id] : '' }}
                                </div>
                            </td>

                            <td rowspan="2" style="text-align: left; vertical-align: center;">
                                {{ isset($project->projectReview->target[$mile->id]) && $project->projectReview->target[$mile->id] == 'achived' ? '✓' : '' }}
                            </td>
                            <td rowspan="2" style="text-align: left; vertical-align: center;">
                                {{ isset($project->projectReview->target[$mile->id]) && $project->projectReview->target[$mile->id] == 'not_achived' ? '✓' : '' }}
                            </td>
                            ...
                            @endif
                            <td rowspan="2" style="text-align: left; vertical-align: center;word-wrap:break-word;">
                                {{ $project->projectReview->remarks[$mile->id] ?? '' }} </td>
                        </tr>
                        <tr>
                            <td>
                                P
