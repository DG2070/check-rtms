...
@section('title', 'Progress Report Performance')
...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <a href="{{ route('progress.report.filter') }}" class="btn btn-danger rounded-0 ml-2">Clear</a>
                        </div>
                    </div>
                </div>
            </form>
            ...
            @if ($program && $program->project && count($program->project) > 0)
                <div class="card card-body">
                    ...
                    <div class="text-right d-flex justify-content-end">
                        ...
                        <form action="{{ route('progress.report.download') }}" method="POST" class="mx-2">
                            @csrf
    ...
    <script type="text/javascript">
        ...
        function downloadProgressReport() {
            ...
            document.querySelector("form#download-progress-report").submit();
