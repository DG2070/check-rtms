...
@section('content')
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    @if (!empty($program_name) && $program_name != '')
    ...
    <div style="background: #EDEFF2; padding: 30px;">
        ...
        {{-- controls --}}
        @include('admin.internal.projects.partials.controls')
        {{-- !ENDS controls --}}
                        ...
                        <div class="card mt-3 tab-card">
                            <div class="card-header tab-card-header">
                                <ul class="nav nav-tabs card-header-tabs" id="newProgramTabs" role="tablist">
                                    {{-- @include('admin.internal.projects.partials.tabs-head') --}}
                                </ul>
                            </div>

                            <div class="tab-content" id="newProgramTabsContent">
                                {{-- @include('admin.internal.projects.partials.tabs-content') --}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('programs.store') }}">
                        @csrf
                        {{-- <input type="hidden"  name="fiscal_year" value="79/80" required> --}}
                        <div class="row">
