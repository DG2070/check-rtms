...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: url('{{ storage_path('fonts/Kalimati Regular.ttf') }}') format('truetype');
        }

        @font-face {
            font-family: 'Poppins-Regular';
            /* Define the name of your English font */
            font-style: normal;
            font-weight: 400;
        ...
        body {
            font-family: 'Kalimati Regular', 'Poppins-Regular', sans-serif;
            /* Specify the font family fallbacks */
            font-size: 14px;
        }
    </style>
</head>
    ...
    <div>
        @if (!empty($project_datas))
            ...
            <table border="1" class="table table-responsive custom-table fullscreen_table tdf-table-primary"
                style="text-align: left;width:100%" id="report_table-internal-progress-report">
                <thead>
                    <tr>
                    ...
                    @if (!empty($project_datas))
                        @foreach ($project_datas as $item)
                            <tr>
                                ...
                                <td rowspan="2" style="text-align: left">{{ $item->performance_indicator }}</td>
                                ...
                                <td rowspan="2" style="text-align: left">{{ $item->remark }}</td>
