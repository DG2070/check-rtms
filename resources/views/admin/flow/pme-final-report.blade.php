...
@section('title', 'PME Final Report')

@section('content')


    {{-- breadcrumb section --}}
    @include('admin.flow._partials.breadcrumb', ['page_title' => 'PME Final Report'])
    ...
    <div style="background: #EDEFF2; padding: 30px;">
        ...
        @if (!empty($programId) && !empty($projectId))
            <div class="card card-body">
                <x-flow.pme-final-report-component :programId="$programId" :projectId="$projectId" />
            </div>
        @endif
        {{-- ! content --}}
