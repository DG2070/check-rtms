<div class="home-progress-line-chart-container">
        ...
        <div class="card-body pb-2">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-2">
                    <div class="card bg-light mb-0" style="height: 450px;position: relative;">
                        <div class="card-body">
                            <div class="py-2">
                                <div>
                                    <h5 class="total_title">Milestone Wise Overall Progress FY
                ...
                <div class="col-12 col-md-2">
                    <div class="card bg-light mb-0" style="height: 450px;position: relative;">
                        <div class="card-body">
                            <div class="py-2">
                                <div>
                                    <h5 class="total_title">Milestone Wise Up To Date Progress FY
                                        {{ App\Helper\FiscalYear::curentFullFiscalYear() }}</h5>
                                    <div class="" style="margin-top: 40px">
                                        @php
                                            //for divide by zero error
                ...
                <div class="col-12 col-md-8">
                    <canvas id="home_progress_line_chart_internal"></canvas>
                </div>
    ...
    @push('script')
        <script>
            ...
            var home_progress_line_chart_internal_config = {
                type: 'line',
                data: {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: 'Milestone Wise Monthly Internal Component Progress Chart FY {{ \App\Helper\FiscalYear::curentFullFiscalYear() }} (Project)'
                    },
                    scales: {
                        xAxes: [{
                            display: true,
            ...
            var home_progress_line_chart_internal = new Chart($('#home_progress_line_chart_internal').get(0).getContext(
                '2d'), home_progress_line_chart_internal_config);
        </script>
    @endpush
