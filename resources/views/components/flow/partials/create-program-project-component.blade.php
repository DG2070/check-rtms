                    ...
                    <form method="POST" action="{{ route('programs.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="ProgrammeFundUtilizationStructure"
                                    class="form-control" />
                            </div>
                            <div class="form-group col-md-12">
                                <label for="usr">TdfLoansForConstructionActivities: </label>
                                <input type="text" name="TdfLoansForConstructionActivities"
                                    class="form-control" />
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="TdfGrantsForConstructionActivities"
                                    class="form-control" />
                            </div>
                            <div class="form-group col-md-12">
                    ...
                    <form method="POST" action="{{ route('projects.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="ClientDebtBearingCapacityAssessed"
                                    class="form-control" />
                            </div>
                            <div class="form-group col-md-12">
