<div>
    ...
    @else
        <div class="rounded-select-container">
            <form method="GET" action="" id="form-select-data">
                @csrf
                <input type="hidden" name="isSetTarget" value="{{ $isSetTarget }}">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="program_select" name="programID" required>
                                ...
                                @foreach ($programs ?? [] as $pro)
                                    <option value="{{ $pro->ID }}" {{ $programId == $pro->ID ? 'selected' : '' }}>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('projects.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="usr">Town Name: </label>
                                <select class="form-control select2" name="townID" style="z-index: 1052;">
